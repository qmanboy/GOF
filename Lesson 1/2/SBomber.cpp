    ...
    score(0)
{
    ...
    MyTools::LoggerSingleton::getProxyInstance()->ProxyWriteToLog(string(__FUNCTION__) + " was invoked");
    ...
    pGr->SetPos((uint16_t)offset + 1, groundY);
...
void SBomber::ProcessKBHit()
{
    ...
    MyTools::LoggerSingleton::getProxyInstance()->ProxyWriteToLog(string(__FUNCTION__) + " was invoked. key = ", c);
...
void SBomber::TimeFinish()
{
    ...
    MyTools::LoggerSingleton::getProxyInstance()->ProxyWriteToLog(string(__FUNCTION__) + " deltaTime = ", (int)deltaTime);
}
